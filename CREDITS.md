...
- **Cloth texture** (`assets/cloth.webp`): original, generated by
  ...
  license.
- **Night-sky sanctum textures** (`assets/sanctum/`): "Monastery Stone
  Floor" (platform) and "Rock Wall 08" (standing stones and pedestal) by
  Amal Kumar, from [Poly Haven](https://polyhaven.com/a/monastery_stone_floor)
  ([rock wall](https://polyhaven.com/a/rock_wall_08)), released under
  [CC0](https://polyhaven.com/license) (public domain). Downloaded and
